---
title: Protocol for beetle life history experiment
author: Anthony Pignatelli
date: 10-10-2025
---
...
## Materials
- Large and small metal beetle bowls
- Paintbrush
- Petri dish
- Sieve
- 400 square plastic containers
- 4 Stock Containers
- 2 kg of media
- Metal scoop 
- Labeling tape
...
2. For each label include the following:
...
1. For each stock container, place 100 beetles into each (A-D)
    - 400 beetles total
2. Allow beetles 6 hours to mate
3. Transfer each individual into its own container
...
# Census
1. Take each box and sieve out beetles
2. Count the beetles in the box and place them into a tared petri dish
3. Weigh the beetles
4. Record the number of beetles and the weight for each box
